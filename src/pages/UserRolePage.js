...
function UserRolePage() {
    ...
    const handleCreateRole = async () => {
        try {
            const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/v1/userrole/create`, newRole);
    ...
    const handleUpdateRole = async () => {
        try {
            const response = await axios.put(`${process.env.REACT_APP_API_URL}/api/v1/userrole/update/${currentRole._id}`, currentRole);
    ...
    const handleDeleteRole = async () => {
        try {
            await axios.delete(`${process.env.REACT_APP_API_URL}/api/v1/userrole/delete/${currentRole._id}`);
